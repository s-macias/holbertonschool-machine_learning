...
def pca(X, var=0.95):
    ...
    Returns:
    W (numpy.ndarray): array of shape  shape (d, nd) where nd is the new dimensionality of the transformed X
     weights matrix, W, that maintains var fraction of X‘s original variance
    """